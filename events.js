...
function saveColorToStorage() {
	localStorage.setItem('color', JSON.stringify({hex: baseColor.value}));
}
...
document.querySelectorAll('.color-container').forEach(colorContainer => {

	// Valitaan tärkeimmät HTML-elementit
	const colorPicker = colorContainer.querySelector(".color-picker");
	const hexValue = colorContainer.querySelector(".hex");

	const rgbValue = colorContainer.querySelector(".rgb");
	const redSlider = colorContainer.querySelector(".red");
	const greenSlider = colorContainer.querySelector(".green");
	const blueSlider = colorContainer.querySelector(".blue");

	const hslValue = colorContainer.querySelector(".hsl");
	const hueSlider = colorContainer.querySelector(".hue");
	const saturationSlider = colorContainer.querySelector(".saturation");
	const lightnessSlider = colorContainer.querySelector(".lightness");

	const cmykValue = colorContainer.querySelector(".cmyk");
	const cyanSlider = colorContainer.querySelector(".cyan");
	const magentaSlider = colorContainer.querySelector(".magenta");
	const yellowSlider = colorContainer.querySelector(".yellow");
	const blackSlider = colorContainer.querySelector(".black");
	...
	function updateColorFromColorPicker() {
		...
		if (hueSlider && saturationSlider && lightnessSlider) updateHslSliderBackgrounds();
		// Päivitä CMYK
	...
	if (rgbValue) { rgbValue.addEventListener("input", () => {
	...
	if (hslValue) { hslValue.addEventListener("input", () => {
	...
	if (cmykValue) { cmykValue.addEventListener("input", () => {
